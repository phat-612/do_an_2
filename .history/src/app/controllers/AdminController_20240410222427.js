...
class AdminController {
  ...
  category(req, res, next) {
    ...
    if (categoryId) {
      // Yêu cầu hiển thị chi tiết danh mục dựa trên ID
      Category.findById(categoryId)
        .then((category) => {
          res.render("admin/sites/category_detail", {
            layout: "admin",
            js: "admin/category_detail",
            css: "admin/category_detail",
            category: mongooseToObject(category),
          });
        })
        .catch((err) => console.log(err));
    } else {
      // Yêu cầu hiển thị danh sách danh mục
      Category.find({})
        ...
        .then((categories) => {
          res.render("admin/sites/category", {
            ...
            js: "admin/category",
            css: "admin/category",
            category: multipleMongooseToObject(categories),
          });
        })
        .catch((err) => console.log(err));
    }
