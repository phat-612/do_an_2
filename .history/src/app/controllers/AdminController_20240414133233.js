      ...
      .then((warranty) => {
        ...
        Product.find({}).then((products) => {
          ...
          products.forEach((product) => {
            ...
            // Kiểm tra xem product có phải là undefined hay không
            if(product && product._doc) {
        
               let productFound = productsAndReasons.find(
                 (productAndReason) => productAndReason.productName === product.name
               );
               ...
               if (productFound) {
                 ...
                 // Ghi lỗi nếu sản phẩm không tìm thấy trong 'productsAndReasons'
                 console.error(`Sản phẩm ${product.name} không tìm thấy trong 'productsAndReasons'`);
               }
            }
          });
