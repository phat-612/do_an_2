    ...
    Warranty.findById(req.params.id)
      ...
      .then((warranty) => {
        ...
        products.forEach((product) => {
          productsAndReasons.forEach((productAndReason) => {
            if (productAndReason.productName == product.name) {
        ...
        Product.find({}).then((products) => {
          res.render("admin/warrantys/edit-warranty", {
            ...
            warranty: mongooseToObject(warranty),
            productsAndReasons,
            products: multipleMongooseToObject(products), // Convert products to objects
          });
