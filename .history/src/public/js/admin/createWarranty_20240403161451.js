...
addProductButton.addEventListener("click", function () {
  ...
  if (selectedOption !== "" && selectedProductId !== "") {
    ...
    addButton.addEventListener("click", function () {
      ...
      newReasonInput.name = `details[${currentProductContainer.id}][reasonAndPrice][${reasonCounter}][reason]`;
      ...
      newPriceInput.name = `details[${currentProductContainer.id}][reasonAndPrice][${reasonCounter}][price]`;
      ...
      reasonCounter++; // Thay đổi vị trí tăng giá trị của reasonCounter
      currentProductContainer.setAttribute(
        "data-reason-counter",
