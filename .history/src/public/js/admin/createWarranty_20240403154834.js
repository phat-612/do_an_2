...
addProductButton.addEventListener("click", function () {
  ...
  if (selectedOption !== "" && selectedProductId !== "") {
    ...
    productContainer.id = "product-container[" + counter + "]";
    ...
    productIdInput.name = `details[${counter}][idProduct]`;
    ...
    addButton.addEventListener("click", function () {
      ...
      newReasonInput.name = `details[${counter}][reasonAndPrice][${reasonCounter}][reason]`;
      ...
      newPriceInput.name = `details[${counter}][reasonAndPrice][${reasonCounter}][price]`;
