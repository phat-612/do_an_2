...
function handleEditCategory(event) {
  ...
  // Thực hiện các thao tác cần thiết khi sửa danh mục
  // Ví dụ: Chuyển hướng đến trang chỉnh sửa danh mục
  window.location.href = "/admin/sites/category/" + categoryId + "?_method=";
}
