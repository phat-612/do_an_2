...
document.querySelectorAll(".edit-category-btn").forEach(function (btn) {
  btn.addEventListener("click", function (event) {
    ...
    // Hiển thị modal chỉnh sửa với dữ liệu danh mục tương ứng
    showEditModal(categoryId);
  });
});

// // Hàm hiển thị modal chỉnh sửa với dữ liệu danh mục
// function showEditModal(categoryId) {
//   // Lấy dữ liệu danh mục từ categoryId và điền vào modal
//   // ...
